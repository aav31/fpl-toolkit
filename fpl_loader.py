...
class FplLoader:
    '''
    Class allowing you to get data from the FPL API
    ...
    @classmethod
    @lru_cache(maxsize=None)
    def get_fixture_info(cls, fixture_id: int) -> Dict:
        '''
        ...
        '''
        fixture_infos = []
        for fixture_info in cls.get_fixtures():
    ...
    @classmethod
    @lru_cache(maxsize=None)
    def get_team_basic_info(cls, team_id: int) -> Dict:
        '''
        ...
        '''
        for team_info in cls.get_static_info()['teams']:
    ...
    @classmethod
    @lru_cache(maxsize=None)
    def get_next_gameweek(cls, as_of_ts: str='now') -> int:
        '''
        ...
        df = pd.DataFrame(cls.get_static_info()['events'])
    ...
    @classmethod
    @lru_cache(maxsize=None)
    def get_my_historical_team_from_gameweek(cls, gameweek: int, manager_id: int) -> Dict[str, Any]:
        '''
        ...
        if not (0 < gameweek < cls.get_next_gameweek()):
    ...
    @classmethod
    @lru_cache(maxsize=None)
    def get_player_basic_info(cls, player_id: int) -> Dict[str, Any]:
        '''
        ...
        '''
        for player_info in cls.get_static_info()['elements']:
    ...
    @classmethod
    def get_player_historical_info_for_gameweek(cls, player_id: int, gameweek: int) -> List[Dict]:
        '''
        ...
        '''
        player_history = cls.get_player_detailed_info(player_id)['history']
        result = []
    ...
    @classmethod
    def get_player_future_info_for_gameweek(cls, player_id: int, gameweek: int) -> List[Dict]:
        '''
        ...
        :return: list of fixtures containing the player's stats - may be more than one if double gameweek and 0 if blank
        '''
        player_history = cls.get_player_detailed_info(player_id)['fixtures']
        result = []
        for player_info in player_history:
    ...
    @classmethod
    def get_position_info(cls, position_id: int) -> Dict[str, Any]:
        '''
        ...
        '''
        for position in cls.get_static_info()['element_types']:
