...
class TestTeam(unittest.TestCase):
    ...
    def test_lt(self):
        ...
        self.assertLess(team_1, team_2, "Team 2 has more free transfers therefore better")
        ...
        self.assertLess(team_2, team_3, "Even though team 3 has less free transfers it has more money in the bank so better")
    ...
    def test_is_feasible(self):
        ...
        team_4 = Team(
            gkps=frozenset([self.gkp_club_1, self.gkp_club_2]),
            defs=frozenset([self.def_club_1, self.def_club_2, self.def_club_3, self.def_club_4, self.def_club_5]),
            mids=frozenset([self.mid_club_1, self.mid_club_2, self.mid_club_3, self.mid_club_4]),
            fwds=frozenset([self.fwd_club_3, self.fwd_club_4, self.fwd_club_5]),
            money_in_bank=0,
            free_transfers=-5
        )
    ...
    def test_transfer_player(self):
        ...
        team_too_many_from_one_club = old_team.transfer_player(self.mid_club_5, another_mid_club_1)
